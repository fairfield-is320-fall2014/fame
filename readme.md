...
12. Within the New Project Wizard, indicate that you want to â `Create new project at existing location` and then browse to set the Directory to the `sites` folder. Then name your project `famedev` at the top of the dialog. Hit the `Finish` button to complete the setup.
